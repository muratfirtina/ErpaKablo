...
public class NewsletterRepository : EfRepositoryBase<Newsletter, string, ErpaKabloDbContext>, INewsletterRepository
{
    public NewsletterRepository(ErpaKabloDbContext context) : base(context) { }
